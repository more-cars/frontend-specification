...
Feature: MAGAZINE ISSUE detail page » Lead IMAGE
  ...
  Rule: The detail page shows the lead image of the MAGAZINE ISSUE
    ...
    @TEST_MCF-1232 @implemented
    Scenario: Expecting a photo of the MAGAZINE ISSUE to be displayed on the detail page
      When the user visits the detail page of a "MAGAZINE ISSUE"
      Then the page should contain a photo section
      And the photo section should contain an image of the "MAGAZINE ISSUE"
