...
Feature: MAGAZINE ISSUE detail page » Lead IMAGE
  ...
  @RULE_MCF-2176
  Rule: License information is displayed for the MAGAZINE ISSUE lead image

    @TEST_MCF-2197 @implemented
    Scenario: Expecting to see license information for the MAGAZINE ISSUE lead image
